...
const topics = [
  { name: 'Atomic Structure', items: ['Atomic Theory', 'Bonding & Structure', 'Periodicity', 'The Periodic Table'] },
  { name: 'Chemical Reactions', items: ['Rates & Equilibrium', 'Acids, Bases & Salts', 'Redox Reactions', 'Electrochemistry'] },
  { name: 'Organic Chemistry', items: ['Hydrocarbons', 'Alcohols & Acids', 'Polymers', 'Petrochemicals'] },
  { name: 'Quantitative Chemistry', items: ['Moles & Formulae', 'Titrations', 'Electrolysis Calculations', 'Empirical Formulae'] },
]
...
export default function OLevelChemistryTutorPage() {
  return (
    <div className="min-h-screen bg-white">
      <section className="bg-gradient-to-br from-green-50 via-white to-teal-50 py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}
            ...
            <BeakerIcon className="w-4 h-4" /> O-Level Chemistry
          </motion.div>
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.6 }}
            className="text-5xl lg:text-6xl font-bold text-gray-900 mb-6">O-Level Chemistry Tutor</motion.h1>
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.6 }}
            className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
            Online O-Level Chemistry tutoring tailored to the Cambridge International syllabus — helping students master content, improve confidence, and target top grades.
          </motion.p>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-gray-500 text-center mb-10">Full O-Level Chemistry curriculum — Cambridge International syllabus</p>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-10">Why Choose Our O-Level Chemistry Tutoring?</h2>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-green-600 to-teal-600 text-white text-center">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-3xl font-bold mb-4">Ready to Improve Your O-Level Chemistry Grade?</h2>
